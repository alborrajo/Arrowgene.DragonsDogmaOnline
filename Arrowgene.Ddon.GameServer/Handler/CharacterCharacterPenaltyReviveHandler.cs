...
namespace Arrowgene.Ddon.GameServer.Handler
{
    public class CharacterCharacterPenaltyReviveHandler : GameRequestPacketHandler<C2SCharacterCharacterPenaltyReviveReq, S2CCharacterCharacterPenaltyReviveRes>
    {
        ...
        public override void Handle(GameClient client, StructurePacket<C2SCharacterCharacterPenaltyReviveReq> request, S2CCharacterCharacterPenaltyReviveRes response)
        {
            // Weakness
